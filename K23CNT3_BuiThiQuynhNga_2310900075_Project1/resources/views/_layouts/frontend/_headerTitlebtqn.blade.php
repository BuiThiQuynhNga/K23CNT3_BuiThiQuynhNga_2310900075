  ...
  <div class="header bg-gradient-to-r from-purple-500 to-pink-500">
    <div class="container mx-auto">
      ...
      <div class="flex justify-between items-center py-2 text-sm">
        <div>
          <a class="mr-4" href="{{route('btqnuser.home1')}}">Trang Chủ</a>
        ...
        <div class="flex items-center space-x-4">
          ...
          <a class="hover:underline" href="btqn-user/support">
          ...
          @if(Session::has('username1'))
              <a class="hover:underline" href="{{ route('btqnuser.home') }}">
                  Đăng Xuất
              </a>
          @else
              <a class="hover:underline" href="{{ route('btqnuser.login') }}">
                  Đăng Nhập
              </a>
          @endif
        </div>
      ...
      <div class="flex items-center py-4">
        <div class="flex items-center">
          <a href="{{route('btqnuser.home1')}}">
              <img alt="logo" class="mr-2" height="130" src="images/logo_login.png" width="130"/>
          </a>
          <span class="text-2xl font-bold" style="color: rgb(255, 99, 71);">btqn SMART</span>
        </div>
        <div class="flex-grow mx-4">
          <form action="{{route('btqnuser.search1')}}" method="GET" class="flex">
